...
const requireFoolWebpack = require('./requireFoolWebpack');
...
function setupWorker(script, options) {
  ...
  } if (options.workerType === 'thread') { // node.js only
    WorkerThreads = ensureWorkerThreads();
    return setupWorkerThreadWorker(script, WorkerThreads);
  } if (options.workerType === 'process' || !options.workerType) { // node.js only
