...
function Yargs(processArgs = [], cwd = shim.process.cwd(), parentRequire) {
  ...
  self.getGroups = () => ({ ...groups, ...preservedGroups });
  ...
  self._parseArgs = function parseArgs(args, shortCircuit, _calledFromCommand, commandIndex) {
    ...
    const config = { ...options.configuration, 'populate--': true };
    const parsed = shim.Parser.detailed(args, { ...options, configuration: { 'parse-positional-numbers': false, ...config } });
    let { argv } = parsed;
    if (parseContext) argv = { ...argv, ...parseContext };
